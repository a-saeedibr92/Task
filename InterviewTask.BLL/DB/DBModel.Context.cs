...
namespace InterviewTask.BLL.DB
{
    ...
    public partial class DBModel : DbContext
    {
        ...
        [DbFunction("DBModel", "Fn_Generate_InoviceNo")]
        public virtual IQueryable<Fn_Generate_InoviceNo_Result> Fn_Generate_InoviceNo(Nullable<int> invoiceId)
        {
            var invoiceIdParameter = invoiceId.HasValue ?
                new ObjectParameter("InvoiceId", invoiceId) :
                new ObjectParameter("InvoiceId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<Fn_Generate_InoviceNo_Result>("[DBModel].[Fn_Generate_InoviceNo](@InvoiceId)", invoiceIdParameter);
        }
    
        [DbFunction("DBModel", "Fn_GenerateInoviceNo")]
        public virtual IQueryable<Fn_GenerateInoviceNo_Result> Fn_GenerateInoviceNo(Nullable<int> region_id)
        {
            var region_idParameter = region_id.HasValue ?
                new ObjectParameter("Region_id", region_id) :
                new ObjectParameter("Region_id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<Fn_GenerateInoviceNo_Result>("[DBModel].[Fn_GenerateInoviceNo](@Region_id)", region_idParameter);
        }
    
        [DbFunction("DBModel", "GenerateInoviceNo")]
        public virtual IQueryable<GenerateInoviceNo_Result> GenerateInoviceNo(Nullable<int> region_id)
        {
            var region_idParameter = region_id.HasValue ?
                new ObjectParameter("Region_id", region_id) :
                new ObjectParameter("Region_id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GenerateInoviceNo_Result>("[DBModel].[GenerateInoviceNo](@Region_id)", region_idParameter);
        }
        ...
        [DbFunction("DBModel", "Fn_Generate_AllInoviceNo")]
        public virtual IQueryable<Fn_Generate_AllInoviceNo_Result> Fn_Generate_AllInoviceNo()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<Fn_Generate_AllInoviceNo_Result>("[DBModel].[Fn_Generate_AllInoviceNo]()");
        }
    }
}
